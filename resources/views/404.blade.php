                        ...
                        <div class="collapse navbar-collapse main-menu-wrap" id="navbarSupportedContent">
                            ...
                            <div class="other-options md-none">
                                <div class="option-item">
                                    <button class="searchbtn" type="button"><i class="flaticon-search-interface-symbol"></i></button>
                                </div>
                                <div class="option-item">
                                    <a href="add-listing.html" class="btn-two">Add Listing</a>
                                </div>
                ...
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
                        <div class="error-content">
                            ...
                            <a href="index.html" class="btn-two">Back To home</a>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="footer-widget">
                            ...
                            <ul class="contact-info list-style">
                                ...
                                <li>
                                    ...
                                    <h6>Email</h6>
                                    <a href="https://templates.hibotheme.com/cdn-cgi/l/email-protection#422a272e2e2d022f2d362d386c212d2f"><span class="__cf_email__" data-cfemail="462e232a2a29062b2932293c6825292b">[email&#160;protected]</span></a>
                                </li>
                                <li>
