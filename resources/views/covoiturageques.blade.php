...
<!-- Mirrored from templates.hibotheme.com/motoz/default/faq.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 10 Feb 2023 13:17:15 GMT -->
<head>
        <!-- Required meta tags -->
        <meta charset="utf-8">
        ...
        <div class="sidebar-popup">
            <div class="sidebar-popup-wrap">
                ...
                <ul class="contact-box list-style">
                    ...
                    <li>
                        <b>Email:</b>
                        <a href="https://templates.hibotheme.com/cdn-cgi/l/email-protection#7a121f1616153a17150e150054191517"><span class="__cf_email__" data-cfemail="dcb4b9b0b0b39cb1b3a8b3a6f2bfb3b1">[email&#160;protected]</span></a>
                    </li>
                </ul>
                <ul class="social-profile list-style">
                    <li>
                                ...
                                <div class="accordion-item">
                                    <h2 class="accordion-header" id="headingOne">
                                        <button class="accordion-button" type="button"
                                            ...
                                            Offrez-vous des bon services?                                        </button>
                                    </h2>
                                    <div id="collapseOne" class="accordion-collapse collapse show"
                                        aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                                        <div class="accordion-body">
                                            <div class="single-product-text">
                                                <p>covoiturage est une application de mobilité pour se déplacer rapidement et au meilleur prix. En quelques clics seulement un chauffeur à proximité vient vous chercher. Il s’agit de profiter d’un trajet à un prix abordable pour se déplacer librement. Pour commander une course, il faut ouvrir l’application et entrer sa destination principale</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="footer-widget">
                            ...
                            <ul class="contact-info list-style">
                                ...
                                <li>
                                    ...
                                    <h6>Email</h6>
                                    <a href="https://templates.hibotheme.com/cdn-cgi/l/email-protection#fb939e979794bb96948f9481d5989496"><span class="__cf_email__" data-cfemail="9ef6fbf2f2f1def3f1eaf1e4b0fdf1f3">[email&#160;protected]</span></a>
                                </li>
                                <li>
