...
@section('content')
                            ...
                            <!-- PAGE-HEADER END -->
  <!-- Search -->
  <form class="app-search d-none d-lg-block" action="/searchadmine">
                        ...
                        </form>                   <div class="row row-sm">
                                <div class="col-lg-12">
                                    <div class="card">
                                        <a href="imprimadmin" class="btn btn-secondary btn-lg active" role="button" aria-pressed="true">imprimer cette page</a>
