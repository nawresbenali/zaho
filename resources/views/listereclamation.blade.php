...
@section('content')
                            ...
                            <!-- Row -->
                            <form class="app-search d-none d-lg-block" action="/searchreclamation">
                            ...
                            <div class="row row-sm">
                                <div class="col-lg-12">
                                    <div class="card">
                                        <a href="imprimreclamation" class="btn btn-secondary btn-lg active" role="button" aria-pressed="true">imprimer cette page</a>
                                                ...
                                                <table class="table table-bordered text-nowrap border-bottom" id="basic-datatable">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th class="wd-20p border-bottom-0">nomdechauufeur</th>
...
<a href ="suppreclamation/{{$data->id}}" class="btn btn-danger">supprimer</a>
